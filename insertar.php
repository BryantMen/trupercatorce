...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $sql = "INSERT INTO herramientas (nombre, precio, stock) VALUES ('$nombre', $precio, $stock)";
...
<head>
    <meta charset="UTF-8">
    <title>Agregar Herramienta - Truper</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        <div class="form-body">
            ...
            <form method="POST">
                <div class="input-group">
                    ...
                    <input type="text" name="nombre" placeholder="Ej: Martillo de bola" required>
                </div>
                <div class="input-group">
                ...
                <button type="submit" class="btn-guardar" onclick="return confirm('¿Estás seguro de agregar esta herramienta?');">Guardar herramienta</button>
